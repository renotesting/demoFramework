...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<cucumber-create-meta>.freeze, ["~> 6.0", ">= 6.0.1"])
    ...
    s.add_runtime_dependency(%q<cucumber-html-formatter>.freeze, ["~> 17.0", ">= 17.0.0"])
    s.add_runtime_dependency(%q<cucumber-messages>.freeze, ["~> 17.1", ">= 17.1.1"])
    s.add_runtime_dependency(%q<cucumber-wire>.freeze, ["~> 6.2", ">= 6.2.0"])
    ...
    s.add_development_dependency(%q<nokogiri>.freeze, ["~> 1.12", ">= 1.12.5"])
    ...
    s.add_development_dependency(%q<test-unit>.freeze, ["~> 3.4", ">= 3.4.8"])
    ...
    s.add_dependency(%q<cucumber-create-meta>.freeze, ["~> 6.0", ">= 6.0.1"])
    ...
    s.add_dependency(%q<cucumber-html-formatter>.freeze, ["~> 17.0", ">= 17.0.0"])
    s.add_dependency(%q<cucumber-messages>.freeze, ["~> 17.1", ">= 17.1.1"])
    s.add_dependency(%q<cucumber-wire>.freeze, ["~> 6.2", ">= 6.2.0"])
    ...
    s.add_dependency(%q<nokogiri>.freeze, ["~> 1.12", ">= 1.12.5"])
    ...
    s.add_dependency(%q<test-unit>.freeze, ["~> 3.4", ">= 3.4.8"])
