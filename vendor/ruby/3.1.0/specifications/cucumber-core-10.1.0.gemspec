...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<cucumber-tag-expressions>.freeze, ["~> 4.0", ">= 4.0.2"])
    ...
    s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.22", ">= 1.22.1"])
    ...
    s.add_dependency(%q<cucumber-tag-expressions>.freeze, ["~> 4.0", ">= 4.0.2"])
    ...
    s.add_dependency(%q<rubocop>.freeze, ["~> 1.22", ">= 1.22.1"])
